...
function Icon({ name, size = 18, color = "currentColor" }) {
  ...
  const icons = {
    ...
    report:  <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>,
    ...
    sub:     <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>,
    ...
    bell:    <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>,
    chat:    <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
    ...
    alert:   <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>,
    ...
    moon:    <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>,
    sun:     <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>,
    chevron: <svg {...s} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2"><polyline points="6 9 12 15 18 9"/></svg>,
  };
  return icons[name] || null;
}

export default function Sidebar({ navItems, onNavClick, activeNav, theme, logo, minimized: initialMinimized = false }) {
  ...
  return (
    <div style={{
      ...
      boxShadow: T.bg === "#070b1a" ? "none" : "2px 0 16px rgba(15,23,42,0.05)",
      position: "relative"
    }}>
      {/* Logo */}
      <div style={{
        ...
        {!minimized && (
          <div>
            <div style={{ fontSize: "0.88rem", fontWeight: 800, color: T.text, letterSpacing: "-0.01em" }}>PCSoft</div>
            <div style={{ fontSize: "0.65rem", color: T.textMuted, letterSpacing: "0.06em" }}>ANALYTICS</div>
          </div>
        )}
      </div>
      ...
      <nav style={{
        ...
        {navItems.map(item => {
          ...
          return (
            ...
            >
              {typeof item.icon === 'string' ? <Icon name={item.icon} size={17} color={active ? T.navActive : T.navInactive} /> : item.icon}
              {!minimized && (
                <>
                  <span style={{
                    fontSize: "0.82rem",
