...
const navItems = [
  { label: "Home", badge: null, icon: "home" },
  { label: "Data Sources", badge: "3", icon: "db" },
  { label: "Data Sets", badge: null, icon: "layers" },
  { label: "Reports", badge: "12", icon: "report" },
  { label: "Questions", badge: null, icon: "question" },
  { label: "Dashboards", badge: "5", icon: "dash" },
  { label: "Subscriptions", badge: null, icon: "sub" },
  { label: "Performance", badge: null, icon: "trend" },
];
